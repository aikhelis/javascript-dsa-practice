...
class DoublyLinkedList {
    ...
    /* 
    0. return if length < 2 
    1. create pointer current and set to head
    2. traverse the list and swap values of the next and prev pointers for each node 
    loop while current !=== null
        let next = current.next
        current.next = current.prev
        current.prev = next
        current = next
    3. swap values of the head and tail pointers
    */
    reverse() {
